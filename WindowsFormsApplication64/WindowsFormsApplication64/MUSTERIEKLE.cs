...
void INSERT()
           {                                        //VERİ EKLEME KODLARI
                                                    baglanti = new SqlConnection(yol);
                                                    string verıtabanı = "INSERT INTO MUSTERILER(ADISOYADI,GRUPADI,SEHIR,VERGIDAIRESI,VERGINO,TELEFON1,TELEFON2,FAX,CEPTELEFONU,SEHIR,ADRES,EMAIL,CINSIYET,DURUMU) VALUES (@ADISOYADI,@GRUPADI,@SEHIR,@VERGIDAIRESI,@VERGINO,@TELEFON1,@TELEFON2,@FAX,@CEPTELEFONU,@SEHIR,@ADRES,@EMAIL,@CINSIYET,@DURUMU)";
